      ...
      <b-card bg-variant="light">
        ...
        >
          ...
          >
            ...
            <button  class="mt-5 btn w-100" block @click="getProduct">Get</button>
          </b-form-group>
        </b-form-group>
      </b-card>
    </div>
    <div v-if="productID" class="mt-3">
      <b-card bg-variant="light">
        <b-form-group
          label-cols-lg="3"
        ...
        >
          ...
          >
            <b-form-tags
              ...
              v-model="description"
              class="mb-2"
              placeholder="Add Decriciption"
            ></b-form-tags>
          </b-form-group>

          <b-form-group label-cols-sm="3" label="Photo:" label-align-sm="right" class="mb-0">
            <b-form-tags
              input-id="tags-basic"
              v-model="photo"
